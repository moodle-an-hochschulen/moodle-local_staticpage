...
$string['settingspagelistentrystandardfail'] = 'The document should be available at the following standard URL, but actually a browser won\'t be able to download and view it (perhaps there is something wrong with your webserver configuration - see README file for details):<br /><strong>{$a}</strong>';
$string['settingspagelistentrystandardsuccess'] = 'The document is available and can be linked to at the following standard URL:<br /><strong>{$a}</strong>';
$string['settingspagelistentryrewritefail'] = 'The document should be available to at the following clean URL, but actually a browser won\'t be able to download and view it (perhaps there is something wrong with your webserver or mod_rewrite configuration - see README file for details):<br /><strong>{$a}</strong>';
$string['settingspagelistentryrewritesuccess'] = 'The document is available and can be linked to at the following clean URL:<br /><strong>{$a}</strong>';
