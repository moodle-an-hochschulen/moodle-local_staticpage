...
$string['settingspagelistentrystandarddisabled'] = 'The static page should be available at the following standard URL, but is not checked because checkavailability is set to No:<br /><strong>{$a}</strong>';
...
$string['settingspagelistentrystandardfail'] = 'The static page should be available at the following standard URL, but actually a browser won\'t be able to download and view it due to non-2xx status code (perhaps there is something wrong with your webserver configuration - see README file for details):<br /><strong>{$a}</strong>';
...
$string['settingspagelistentryrewritedisabled'] = 'The static page should be available to at the following clean URL, but is not verified because checkavailability is set to No:<br /><strong>{$a}</strong>';
...
$string['settingspagelistentryrewritefail'] = 'The static page should be available to at the following clean URL, but actually a browser won\'t be able to download and view it due to non-2xx status code (perhaps there is something wrong with your webserver or mod_rewrite configuration - see README file for details):<br /><strong>{$a}</strong>';
...
$string['checkavailability_desc'] = 'Configure if Moodle should check for static file availability.';
...
$string['checkavailabilityconnecttimeout_desc'] = 'The number of seconds to wait while trying to connect. Use 0 to wait indefinitely.';
$string['checkavailabilitytimeout'] = 'Timeout';
$string['checkavailabilitytimeout_desc'] = 'The maximum number of seconds to allow cURL functions to execute.';
